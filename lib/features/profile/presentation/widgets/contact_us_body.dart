...
class _ContactUsBodyState extends State<ContactUsBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => sl<ProfileBloc>()..add(GetContactUsDataEvent()),
      child: BlocBuilder<ProfileBloc, ProfileState>(
        builder: (context, state) {
          switch (state.runtimeType) {
            case ProfileLoading:
              return Center(child: CircularProgressIndicator());
            case GetContactUsDataSuccessState:
              final data =
                  (state as GetContactUsDataSuccessState).contactUSModel;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildContactInfoCard(
                      icon: Icons.email,
                      title: 'Email',
                      value: data.primaryEmail.toString(),
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Email opened in mail app'),
                          ),
                        );
                      },
                    ),
                    ...
                    _buildContactInfoCard(
                      ...
                      value: data.secondaryEmail.toString(),
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Email opened in mail app'),
                    ...
                    _buildContactInfoCard(
                      icon: Icons.phone,
                      title: 'Primary Phone',
                      value: data.primaryMobile.toString(),
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Phone app would open here'),
                          ),
                        );
                      },
                    ),
                    ...
                    _buildContactInfoCard(
                      ...
                      value: data.secondaryMobile.toString(),
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Phone app would open here'),
                    ...
                    _buildContactInfoCard(
                      ...
                      title: 'Address',
                      value: data.headOfficeAddress.toString(),
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
