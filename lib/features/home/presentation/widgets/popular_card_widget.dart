  ...
  Widget courseTileWidget(bool isDark) {
    return BlocProvider(
      create: (context) => sl<CourseBloc>()
        ..add(
          GetCourseListEvent(entity: CourseFilterEntity(popularCategory: '1')),
        ),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        GoRouter.of(
                          context,
                        ).pushNamed(CourseDetailsPage.routeName);
                      },
                      child: Container(
                          ...
                          children: [
                            ...
                            Stack(
                              children: [
                                ClipRRect(
                                  ...
                                  // data.courseList![index].courseIcon != '' || data.courseList![index].courseIcon.i
                                  // ? Image.asset(
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  CustomText(
                                    text: data.courseList![index].courseName
                                        .toString(),
                                    fontSize: 14,
